...
class OldGreggThemePlugin extends ThemePlugin
{
	...
	public function init()
	{
		...
		$this->addStyle('header', 'css/headers.css');
		$this->addStyle('footer', 'css/footer.css');
		$this->addStyle('issue', 'css/issue.css');
		$this->addStyle('site-wide', 'css/mains.css');
		$this->addStyle('index', 'css/index.css');
		$this->addStyle('article', 'css/articler.css');
		$this->addStyle('contact', 'css/contact.css');
		$this->addStyle('overwriting', 'css/overwriting.css');
		$this->addStyle('contact', 'css/contact.css');
		$this->addStyle('jquery-ui', 'jquery-ui/jquery-ui.min.css');
		$this->addStyle('jquery-ui', 'jquery-ui/jquery-ui.structure.min.css');
		$this->addStyle('jquery-ui', 'jquery-ui/jquery-ui.theme.min.css');
